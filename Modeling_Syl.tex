...
\vspace*{.15in}
\noindent\textbf{Grading Policy:} Homework and quizzes (20\%),  Midterm (25\%), Parties attended (25\%), Final (30\%) . %Four Projects (40\% = 4 * 10\%)

\vskip.15in
\noindent\textbf{Important Dates:}
\begin{center} \begin{minipage}{3.8in}
\begin{flushleft}
Midterm     \dotfill ~\={September} 16, 2018  \\
Party Verification Date   \dotfill ~\={October} 21, 2018  \\
%Project Deadline \dotfill ~Month Day \\
Final Exam       \dotfill ~December 18, 2018  \\
\end{flushleft}
\end{minipage}
\end{center}
